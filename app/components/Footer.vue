...
const shareOnX = () => {
    const message =
        "Только что сэкономил 20 минут на локализации с помощью i18nAI! 🚀";
    const url = "https://i18n-ai.timures.me"; // Твой будущий домен
...
onMounted(() => {
    ...
    if (!window.kofiWidgetOverlayConfig) {
        ...
        script.async = true;
        script.onload = () => {
            kofiWidgetOverlay.draw("timures", {
                type: "floating-chat",
            ...
            <div class="flex flex-col md:flex-row justify-between my-5">
                ...
                <div class="flex flex-col md:flex-row gap-4 items-center">
                    <!-- <UButton
                        ...
                        :label="$t('support.boosty')"
                    /> -->

                    <UButton
                        to="https://ko-fi.com/timures"
                        target="_blank"
                        color="neutral"
                        variant="ghost"
                    ...
                    <p>
                        <a
                            ...
                            target="_blank"
                            class="text-muted text-sm hover:cursor-pointer hover:text-white"
                            >Timures.me</a
                        >
                    </p>
                </div>
